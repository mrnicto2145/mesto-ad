function checkNonDefaultUser(user){
    return (user.name !== 'Jacques Cousteau') || (user.about !== 'Sailor, researcher') || (user.avatar !== 'https://pictures.s3.yandex.net/frontend-developer/common/ava.jpg');
};
